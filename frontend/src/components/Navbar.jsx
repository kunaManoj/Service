...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {mobileMenuOpen && (
        <div className="mobile-dropdown glass" style={{ position: 'fixed', top: '100px', left: '15px', right: '15px', padding: '20px', borderRadius: '20px', background: 'rgba(255,255,255,0.95)', zIndex: 999, boxShadow: '0 20px 40px rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column', gap: '15px' }}>
